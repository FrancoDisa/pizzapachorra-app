 ...
 */
export const getClienteByTelefono = async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
export const autocompleteByTelefono = async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
export const getClienteHistorial = async (req: Request, res: Response): Promise<void> => {
  try {
    const idParam = req.params.id;
    if (!idParam) {
      throw new ValidationError('id requerido');
 ...
 */
export const getClientesEstadisticas = async (_req: Request, res: Response): Promise<void> => {
  try {
